...
a = [-1.03417941e+00, -1.00761871e-01 , 6.73265206e-02,-2.64729727e-01,
  2.61363993e-02, -4.00230284e-04] #np.zeros(6)
KE = Functional(type='KEDF',name='TFvW', y=0.2)
...
engine._zval = zval
engine.write('li_lda_tf02vw.psp8')
...
engine_O.write('o_lda_tf02vw.psp8')