...
atoms = read('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/LDA/rho_ks_Li_gbrv.xsf')
ions, rho_ks, _ = io.read_all('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/LDA/rho_ks_Li_gbrv.xsf')
grid = rho_ks.grid
