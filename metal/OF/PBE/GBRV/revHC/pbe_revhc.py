...
atoms = read('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/PBE/rho_ks_Li_gbrv.xsf')
ions, rho_ks, _ = io.read_all('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/PBE/rho_ks_Li_gbrv.xsf', full=True)
# grid = rho_ks.grid
nr = rho_ks.grid.nr
...
engine._zval = zval
np.save('a', a)
engine.write('PGBRV_PBE_revHC.psp8')
