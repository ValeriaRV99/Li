...
atoms = read('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/PBE/rho_ks_Li_oepp.xsf')
ions, rho_ks, _ = io.read_all('/projectsn/mp1009_1/Valeria/Batteries/Li2S_interface/OF/Li/metal/KS/PBE/rho_ks_Li_oepp.xsf', full=True)
# grid = rho_ks.grid
nr = rho_ks.grid.nr

grid = DirectGrid(ions.cell, nr=nr, mp=mp, full=True)
...
engine._zval = zval
np.save('a', a)
engine.write('POEPP_PBE_revHC.psp8')
